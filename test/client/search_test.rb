...
class Tweetkit::Client::SearchTest < Minitest::Test
  def setup
  ...
  def test_evaluate_constructs_the_current_query
    ...
    assert_equal "united is:retweet pogba \"mason greenwood\" has:media OR has:link -from:ManUtd", @search_factory.query
  end
end
